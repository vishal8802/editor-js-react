    ...
    "blocks": [
        ...
        },
        {
            ...
            "data": {
                ...
                "items": [
                    {
                        "content": "Your business plan needs a problem statement because every great company starts by solving an important problem.",
                        "items": []
                    },
                    {
                        "content": "The more accurately you articulate the problem, the more valuable the solution will be. A well-articulated problem makes the value of your solution and your entire plan 10x more effective.",
                        "items": []
                    },
                    {
                        "content": "It’s what intrigues people about the rest of your business and ultimately becomes the focal point for everything you build.",
                        "items": []
                    },
                    {
                        "content": "It tells more of a story, and provides an emotional connection to the solution.",
                        "items": []
                    }
                ]
            }
        ...
        },
        {
            ...
            "data": {
                ...
                "items": [
                    {
                        "content": "The real talent in all entrepreneurship—not only in tech startups—is finding the right problem, not building the right solution",
                        "items": []
                    },
                    {
                        "content": "Identifying the root cause, not the symptoms, is essential to building the right solution. Understand the complexity of the problem",
                        "items": []
                    },
                    {
                        "content": "Go from local to global- build the best solution for a specific group of customers first, then build another average solution for a larger market",
                        "items": []
                    },
                    {
                        "content": "Consider the emotional and quantitative Impact of the problem.",
                        "items": []
                    }
                ]
            }
